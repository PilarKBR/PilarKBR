...
<div align="center">
  <img src="https://readme-typing-svg.demolab.com?font=Fira+Code&size=25&pause=1000&color=4A6FA5&center=true&vCenter=true&random=true&width=700&lines=Data+Scientist+%26+ML+Engineer;ML+Annotator+Intern+at+NRI+Indonesia;Computer+Science+Student+at+Pakuan+University;Ex-MSIB+Batch+6+at+Startup+Campus" alt="Typing SVG" />
</div>
...
I'm a passionate **Data Scientist** and **ML Engineer** with a proven track record in transforming complex data into actionable insights. Currently working as a **Machine Learning Annotator Intern at NRI Indonesia**, where I contribute to AI model training and data quality assurance. 

As a final semester Computer Science student at Pakuan University (GPA 3.89/4.0), I specialize in **Python**, **Machine Learning**, and **Computer Vision**.

🏆 **Recent Achievement:** 3rd Place Winner at IEOM International Conference (Sponsored by Siemens)

With experience as a Data Science & AI Mentee at Startup Campus (MSIB Batch 6) and certified **Associate Data Scientist** by BNSP, I combine theoretical knowledge with hands-on industry experience in delivering impactful AI solutions.

### 💼 What I Do
- � **Currently working at:** NRI Indonesia as Machine Learning Annotator Intern - Contributing to AI model training through high-quality data annotation and validation
- 🔭 **Research Project:** Real-time FFB maturity detection system using YOLOv11 & UAV technology for precision agriculture (Thesis)
- 🌱 **Currently learning:** Deep Learning architectures (YOLOv11, Transformers), MLOps practices, Advanced Computer Vision, and IoT integration
- 👯 **Open to collaboration on:** Data science research, ML/AI projects, computer vision applications, and innovative open-source solutions
- 💬 **Ask me about:** Python, Machine Learning, Deep Learning, Computer Vision, Data Annotation, Data Analytics, Statistical Modeling, Business Intelligence
- 📍 **Location:** Bogor & Sukabumi, Indonesia 🇮🇩
- 🎯 **Career Goal:** Leveraging AI and data science to solve real-world problems, business optimization, and model development
- ⚡ **Fun fact:** I hold a HaKI patent for agricultural computer vision technology and won 3rd place at an international conference!
...
[![Status](https://img.shields.io/badge/Status-Research%20%26%20Development-orange?style=flat-square)](https://github.com/PilarKBR)
[![Tech](https://img.shields.io/badge/Tech-YOLOv11%20%7C%20IoT%20%7C%20Computer%20Vision-blue?style=flat-square)](https://github.com/PilarKBR)

**Advanced Computer Vision with YOLOv11 and IoT Integration**

An innovative precision agriculture system leveraging cutting-edge AI and UAV technology for automated monitoring of oil palm plantations.

**Key Features:**
- 🤖 **YOLOv11** - State-of-the-art object detection for real-time FFB maturity classification
- 🚁 **UAV Integration** - Autonomous aerial monitoring for large-scale plantation coverage
- 🌡️ **Thermal Imaging** - Enhanced detection accuracy using temperature data
- 🌐 **IoT Connectivity** - Real-time data transmission and cloud analytics
- 📊 **Analytics Dashboard** - Actionable insights for plantation management optimization

**Impact:** Revolutionizing traditional harvesting practices with AI-driven precision agriculture.
...
**Statistical Weather Forecasting Using Markov Chain Models**

A hybrid weather prediction system combining statistical modeling with modern mobile technology, recognized at international conference with competitive achievement.

**Technical Stack:**
- ⚡ **C++ Backend** - High-performance computation for Markov chain calculations
- 📱 **Flutter Mobile App** - Cross-platform interface (Android & iOS)
- 📊 **Markov Chain Models** - Probabilistic weather state transitions
- 📈 **Data Analytics** - Historical weather pattern analysis for Bogor City
...
<div align="center">
  ...
  <br>
  <em>Official award certificate for 3rd Place Winner - IEOM Undergraduate Student Paper Competition, sponsored by Siemens.</em>
  <br>
...
[![Project](https://img.shields.io/badge/Project-Startup%20Campus%20Final-blue?style=flat-square)](https://github.com/PilarKBR/Projects)
[![Article](https://img.shields.io/badge/Medium-Article-black?style=flat-square&logo=medium)](https://medium.com/@pilarkbr/segmentasi-pelanggan-menggunakan-rfm-dan-k-means-978f2cfa5ca4)

**Data-Driven Customer Intelligence & Business Analytics**

Comprehensive customer analytics project combining RFM methodology with machine learning clustering and time series forecasting.

**Methodology:**
- 📊 **RFM Analysis** - Recency, Frequency, Monetary value segmentation
- 🤖 **K-means Clustering** - Unsupervised customer group identification
- 📈 **ARIMA Forecasting** - Future spending pattern prediction
- � **Business Insights** - Actionable recommendations for marketing strategies

**Resources:** [GitHub Repository](https://github.com/PilarKBR/Projects) | [Medium Article (Bahasa Indonesia)](https://medium.com/@pilarkbr/segmentasi-pelanggan-menggunakan-rfm-dan-k-means-978f2cfa5ca4)

---

### 🏠 Ames Housing Price Prediction
[![Model](https://img.shields.io/badge/Model-XGBoost-red?style=flat-square)](https://github.com/PilarKBR)
[![Performance](https://img.shields.io/badge/R²%20Score-90.6%25-success?style=flat-square)](https://github.com/PilarKBR)

**Advanced Regression Analysis with Ensemble Learning**
...
### 🎓 Academic Background
- **Bachelor of Computer Science** - Pakuan University, Bogor (2021 - 2025)
  - **GPA:** 3.89/4.0
  - **Focus:** Data Science, Machine Learning, Computer Vision
  - **Thesis:** Real-time FFB Maturity Detection using YOLOv11 and UAV Technology
  - **Expected Graduation:** 2025
  - **Relevant Coursework:** Artificial Intelligence, Data Mining, Image Processing, Database Systems, Algorithm Design
...
- ✅ **Machine Learning Specialization**  
  *DeepLearning.AI (Andrew Ng)* - 2024
...
- ✅ **AI & Machine Learning Mentor**  
  *Lokpro Camp Batch 1* - 2024
- ✅ **Teaching Assistant**  
  *Pakuan University* - 2023-2024
...
<div align="center">
  <a href="https://medium.com/@pilarkbr">
...
<tr>
<td>
<b>Weather Forecasting Using Markov Chains in Bogor City: Software Implementation for Predicting Weather Patterns</b>
<br><em>Statistical modeling approach for local weather prediction</em>
<br><strong>🥉 3rd Place - IEOM Undergraduate Student Paper Competition (Sponsored by Siemens)</strong>
</td>
<td align="center">
✅ <b>Published</b><br>August 2025
</td>
<td>
...
<tr>
<td>
<b>OPEFB-Detection-System: Computer Vision Application for Palm Oil Waste Detection</b>
...
<tr>
<td>
<b>Real-time FFB Maturity Detection using YOLOv11 and UAV Technology</b>
<br><em>AI-driven precision agriculture for oil palm plantations</em>
</td>
<td align="center">
...
- 🎓 **IEOM Asia Pacific Conference 2025** (Bali, August 5-7, 2025)
  - *"Weather Forecasting Using Markov Chains in Bogor City: Software Implementation for Predicting Weather Patterns"*
...
| Title | Topic | Language | Year |
|-------|-------|----------|------|
| **[Segmentasi Pelanggan Menggunakan RFM dan K-means](https://medium.com/@pilarkbr/segmentasi-pelanggan-menggunakan-rfm-dan-k-means-978f2cfa5ca4)** | Customer Analytics, Machine Learning | 🇮🇩 Bahasa Indonesia | 2024 |
...
|-------------|--------|--------------|------|
| **IEOM Undergraduate Student Paper Competition** | 🥉 **3rd Place** | IEOM Society International (Sponsored by Siemens) | 2025 |
...
I'm always open to discussing research opportunities, academic collaborations, or consulting on data science projects.

[![Email](https://img.shields.io/badge/Research%20Inquiry-pilar.kukuh@gmail.com-red?style=for-the-badge&logo=gmail&logoColor=white)](mailto:pilar.kukuh@gmail.com)
[![LinkedIn](https://img.shields.io/badge/Professional%20Network-LinkedIn-blue?style=for-the-badge&logo=linkedin&logoColor=white)](https://linkedin.com/in/pilarkbr)
...
<img src="https://img.shields.io/badge/Visit-000000?style=for-the-badge&logo=github&logoColor=white"/>
</a>
</td>
</tr>
</table>
...
<p>
  ...
  <a href="https://instagram.com/pilarkbr28">
    <img src="https://img.shields.io/badge/Instagram-E4405F?style=for-the-badge&logo=instagram&logoColor=white"/>
  </a>
  <a href="https://twitter.com/pilarkbr">
    <img src="https://img.shields.io/badge/Twitter-1DA1F2?style=for-the-badge&logo=twitter&logoColor=white"/>
  </a>
  <a href="https://github.com/PilarKBR">
...
<p align="center">
  <a href="mailto:pilar.kukuh@gmail.com">
    <img src="https://img.shields.io/badge/Email-pilar.kukuh@gmail.com-D14836?style=for-the-badge&logo=gmail&logoColor=white"/>
  </a>
  <a href="https://linkedin.com/in/pilarkbr">
    <img src="https://img.shields.io/badge/LinkedIn-pilarkbr-0077B5?style=for-the-badge&logo=linkedin&logoColor=white"/>
  </a>
...
<div align="center">
  ...
  <img src="https://img.shields.io/github/followers/PilarKBR?label=Followers&style=flat-square&color=4A6FA5"/>
  <img src="https://img.shields.io/github/stars/PilarKBR?label=Stars&style=flat-square&color=4A6FA5"/>
  
  <br><br>
  
  <p><em>💼 Available for freelance projects and collaboration opportunities</em></p>
  <p><em>⭐ If you find my work helpful, consider giving a star to my repositories!</em></p>
  
  <br>
  
  <img src="https://capsule-render.vercel.app/api?type=waving&color=4A6FA5&height=100&section=footer"/>
  
  <p>
    <sub>© 2025 <a href="https://github.com/PilarKBR">Pilar Kukuh Bintang Rachmadi</a>. Made with ❤️ and ☕</sub>
  </p>
</div>